...
// mongoose.connect(config.CONNECTION_URI, { useNewUrlParser: true, useUnifiedTopology: true }); // not using config any more.
...
// Remove a movie from a user's list of favorites. Note that :MovieID needs to be "89eaf..." not "ObjectID(89eaf...)"
